            ...
            function (t, e, i) {
                ...
                var h = t(1),
                    ...
                    f = (function (t) {
                        ...
                        function i(t) {
                            var n;
                            return (0, r.default)(this, i), (n = e.call(this, t, { className: "ac-gf", miniSelector: ".ac-gf-footer" })), new u(t).htmlClass(), n._initializeBuyStrip(), n;
                        }
                        return (
                            (0, s.default)(i, [
                                {
                                    ...
                                    value: function () {
                                        var t = this;
                                        ((this._buystrip = this.el.querySelector("".concat(this._selectors.wrapper, "-buystrip"))), this._buystrip) &&
                                            (this._buystrip.querySelectorAll("".concat(this._selectors.wrapper, "-buystrip-info-content")).forEach(function (e) {
                                                t._makeBlockLink(e);
                                            }),
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        ...
                                        if (e) {
                                            ...
                                            for (
                                                n.className = "".concat(e.className, " ac-gf-block-link"),
