...
})()(
    {
                ...
                class O extends a {
                    constructor(t) {
                        super(),
                            ...
                            t.video
                                ...
                                : this._textureSrc &&
                                  (this._textureSrc.endsWith(".mp4") || this._textureSrc.endsWith(".m3u8") || this._textureSrc.endsWith(".webm")) &&
                            ...
                            (this._sineEasing = t.sineEasing || w),
                            (this._mapMinValue = void 0 !== t.mapMinValue ? t.mapMinValue : E),
                    ...
                    _update(t) {
                        ...
                        (this._cachedPos = Object.assign({}, n)),
                            ...
                            i && this.trigger(O.POSITION_CHANGE);
                    }
                    refreshSize() {
                        this._onResize();
                    }
                    ...
                    oscillateLongitude() {
                        ...
                        return this._currentTimer
                            ...
                            : (r(this._animateRAF),
                              this.trigger(O.ROTATION_START, i),
                              new Promise((n) => {
                    ...
                    _respositionCameraToPosition(t, e) {
                        ...
                        if ((this._pointerControls.cancelInertia(), this.arrowControls.cancelInertia(), t.lat === this.position.lat && t.lon === this.position.lon))
                            return (
                                this.trigger(O.ROTATION_START, { time: 0, startPosition: Object.assign({}, this.position), targetPosition: Object.assign({}, this.position) }),
                                this.trigger(O.ROTATION_COMPLETE, { time: 1, startPosition: Object.assign({}, this.position), targetPosition: Object.assign({}, this.position) }),
                                Promise.resolve()
                            );
                        ...
                        return (
                            this.trigger(O.ROTATION_START, f),
                            new Promise((e) => {
                ...
                e.exports = class {
                    ...
                    _onOrientation(t) {
                        window.matchMedia("(orientation: portrait)").matches
                            ? ((this._lon = n(this._lon - t.rotationRate.beta * o)), (this._lat = this._lat - t.rotationRate.alpha * o))
                            : t.orientation || -90 === window.orientation
                            ? ((this._lon = n(this._lon + t.rotationRate.alpha * o)), (this._lat = this._lat - t.rotationRate.beta * o))
                            : ((this._lon = n(this._lon - t.rotationRate.alpha * o)), (this._lat = this._lat + t.rotationRate.beta * o));
                    }
                    set position(t) {
        ...
        27: [
            function (t, e, i) {
                ...
                e.exports = function (t, e) {
                    ...
                    else for (var i = r.getTabbableElements(t, e), s = i.length; s--; ) o(i[s], "tabindex"), i[s].setAttribute("tabindex", "-1");
                ...
                ((n = c.prototype).on = function () {
                        ...
                        if (0 !== t.length) {
                            if ("string" == typeof t[0] || null === t[0])
                                return (
                                    ...
                                    (i.events = t[0]),
                                    "string" == typeof t[1] ? ((i.delegateQuery = t[1]), (i.callback = t[2]), (i.context = t[3])) : ((i.callback = t[1]), (i.context = t[2])),
                                    void e.call(this, i)
                                );
                            var n,
                                r,
                            ...
                            for (n in o)
                                o.hasOwnProperty(n) &&
                                    ((i = {}), (r = this._cleanStringData(n.split(":"))), (i.events = r[0]), (i.delegateQuery = r[1]), (i.callback = o[n]), (i.context = t[1]), e.call(this, i));
                        } else e.call(this, i);
                    }),
                    ...
                    (n._unregisterDelegateFuncs = function (t, e) {
                        ...
                        if (this._delegateFuncs[e] && (null === t || this._delegateFuncs[e][t]))
                            ...
                            else for (i in this._delegateFuncs[e]) this._delegateFuncs[e].hasOwnProperty(i) && this._unbindDelegateFunc(i, e);
                    }),
                                ...
                                function (t, e, i, n, r) {
                                    ("string" != typeof n || "function" != typeof e || (t = this._unregisterDelegateFunc(r, n, e, i))) &&
                                        ("string" != typeof n || void 0 !== t
                                            ? ("string" == typeof r && void 0 === t && (this._unregisterDelegateFuncsByEvent(r), "string" == typeof n)) ||
                    ...
                    (n._handleDelegateOnce = function (t, e, i, n) {
                        return (
                            ...
                            this._on({ events: t, context: i, delegateQuery: n, callback: this._getDelegateOnceCallback.bind(this, t, e, i, n), unboundCallback: e }),
        ...
        59: [
            function (t, e, i) {
                "use strict";
                var n,
                    r = { preventDefault: t("@marcom/ac-dom-events/preventDefault"), stopPropagation: t("@marcom/ac-dom-events/stopPropagation"), target: t("@marcom/ac-dom-events/target") },
                    o = function (t, e) {
                        (this._domEmitter = e),
                    ...
                    (e.exports = function (t, e, i) {
                        ...
                        return (
                            t.dispatchEvent
                                ...
                                : ((n = document.createEventObject()), i && "detail" in i && (n.detail = i.detail), t.fireEvent("on" + e, n)),
                            t
                        );
                    });
            },
        ...
        88: [
            function (t, e, i) {
                ...
                e.exports = function (t, e) {
                    return (
                        (e = e || document), n.parentNode(e, !0, "querySelectorAll", "context"), n.selector(t, !0, "querySelectorAll"), o ? Array.prototype.slice.call(e.querySelectorAll(t)) : r(t, e)
                    );
                };
            },
            ...
            function (t, e, i) {
                ...
                n(document, "fullscreenchange", c),
                    ...
                    (a.fullscreenElement = function () {
                        return (
                            document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitCurrentFullScreenElement
                        );
                    }),
        ...
        114: [
            function (t, e, i) {
                ...
                (u.onDown = function (t, e) {
                    ...
                    (u.destroy = function () {
                        return (
                            o(this._context, c, this._DOMKeyDown, !0), o(this._context, l, this._DOMKeyUp, !0), (this._keysDown = null), (this._context = null), n.prototype.destroy.call(this), this
                        );
                    }),
            ...
            function (t, e, i) {
                ...
                (d.open = function () {
                    this.options.retainScrollPosition && this._saveScrollPosition(),
                        this.opened || (this._attachEvents(), this.trigger("willopen"), this.renderer.open(), (this.opened = !0), this.trigger("open"));
                }),
                    (d.close = function (t) {
                        var e, i;
                        if (this.opened) {
        ...
        121: [
            function (t, e, i) {
                ...
                (c.render = function () {
                    return (
                        o.isElement(this.modalElement) || (this.modalElement = this.renderModalElement(this.options.classNames.modalElement)),
                        o.isElement(this.contentElement) || (this.contentElement = this.renderContentElement(this.options.classNames.contentElement)),
                        !1 !== this.closeButton &&
                            (o.isElement(this.closeButton) || (this.closeButton = this.renderCloseButton(this.options.classNames.closeButton)), this.modalElement.appendChild(this.closeButton)),
                    ...
                    (c.destroy = function () {
                        var t = [document.documentElement].concat(this.options.classNames.documentElement);
                        for (var e in (this.modalElement && document.body.contains(this.modalElement) && (this.close(), document.body.removeChild(this.modalElement)), n.remove.apply(null, t), this))
        ...
        125: [
            function (t, e, i) {
                ...
                (a.open = function () {
                    ...
                    (a.destroy = function () {
                        for (var t in (this._releaseEvents(), this._modal.destroy(), this._removeModalFocus(), this._circularTab.destroy(), (this._focusObj = null), this))
            ...
            function (t, e, i) {
                ...
                var n = t("../Modal"),
                    ...
                    o = {
                        ...
                        renderer: { classNames: { documentElement: [r.documentElement].concat("has-modal-full-viewport"), modalElement: [r.modalElement].concat("modal-full-viewport") } },
                    };
                e.exports = function (t, e) {
                    var i = new n(o),
                        r = e || {};
            ...
            function (t, e, i) {
                ...
                (a._isRoot = function (t) {
                    ...
                    (a._handleHashChange = function (t) {
                        this._ignoreHashChange ? (this._ignoreHashChange = !1) : this.trigger("popstate", { fragment: this.fragment() });
                    }),
                    ...
                    (a.start = function () {
                        return (
                            this.started ||
                                ...
                                ((this.started = !0),
                                this._pushState
                                    ? ((this._handlePopState = this._handlePopState.bind(this)), r.addEventListener(window, "popstate", this._handlePopState))
                                    : this._hashChange &&
                                      (this._isHashChangeSupported()
                                          ? ((this._handleHashChange = this._handleHashChange.bind(this)), r.addEventListener(window, "hashchange", this._handleHashChange))
                            ...
                            this._pushState
                                ...
                                : this._hashChange &&
                                  (this._isHashChangeSupported()
                                      ...
                                      : this._checkUrlInterval && (clearInterval(this._checkUrlInterval), (this._checkUrlInterval = null))));
                    }),
                        ...
                        return (
                            this._pushState
                                ...
                                : this._hashChange &&
                                  ...
                                  this._isHashChangeSupported() || (this._iframe.document.open().close(), (this._iframe.location.hash = "#" + t))),
                            !0
                        );
                    }),
                    (a.fragment = function () {
            ...
            function (t, e, i) {
                ...
                function a(t) {
                    (t = t || {}),
                        ...
                        (this.history = t.history || new o({ root: t.root, autoStart: t.autoStart, pushState: t.pushState, hashChange: t.hashChange, resolveInitialHash: t.resolveInitialHash })),
                ...
                (c._handleTrigger = function (t) {
                    if (this.started) {
                        ...
                        e &&
                            (/^(http|https):\/\/+/.exec(e) && "href" === this._interceptAttribute && (e = e.substr(e.indexOf(this.history.root) + this.history.root.length) || "/"),
        ...
        167: [
            function (t, e, i) {
                ...
                function n(t, e, i, n, r) {
                    if (((this.path = t), (this.callback = e), (this.context = i), (this.greedy = n || !1), (this.priority = r || 0), "number" != typeof this.priority))
        ...
        168: [
            function (t, e, i) {
                ...
                (o._getIndex = function (t, e, i) {
                    if (void 0 !== this._routes[t]) for (var n = this._routes[t].length; --n > -1; ) if (this._routes[t][n].callback === e && this._routes[t][n].context === i) return n;
                    return -1;
                }),
                    (o.match = function (t) {
                        var e, i;
                        for (e in this._routes) for (i = this._routes[e].length; --i > -1 && (!this._routes[e][i].match(t) || !this._routes[e][i].greedy); );
                    }),
                    (o.add = function (t) {
                        if (void 0 === this._routes[t.path]) this._routes[t.path] = [t];
                            ...
                            if (i > 0) for (e = 0; e < i; ++e) if (this._routes[t.path][e].priority > t.priority) return this._routes[t.path].splice(e, 0, t), t;
            ...
            function (t, e, i) {
                ...
                (_._addGrabClass = function () {
                    ...
                    (_._onChange = function (t) {
                        ...
                        isNaN(e) ||
                            ("horizontal" === this.getOrientation() ? (this.thumbElement.style.left = e + "%") : (this.thumbElement.style.bottom = e + "%"), this.trigger("change", this.getValue()));
                    }),
                    ...
                    (_._step = function (t, e) {
                        ...
                        i
                            ? Math.abs(this._keyDown[d(t)]) < Math.abs(this.model.max * this.model.keyboardMaxStepPercentage) && (i *= this.model.keyboardStepMultiplier)
                            : (this.trigger("grab", this.getValue()),
                ...
                var n = t("./utils"),
                    r = {
                        ...
                        stringify: function (t, e, i) {
                            if (
                                (n.isBuffer(t) ? (t = t.toString()) : t instanceof Date ? (t = t.toISOString()) : null === t && (t = ""),
            ...
            function (t, e, i) {
                ...
                (a.autoCreate = function (t) {
                    ...
                    0 === this._autoCreatedUrlEls.length
                        ...
                        : ((i = i.filter(this._hasNotBeenAutoCreated.bind(this))), (this._autoCreatedUrlEls = this._autoCreatedUrlEls.concat(i))),
        ...
        190: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "facebook-share", baseLinkPath: "https://www.facebook.com/sharer/sharer.php", dialogDimensions: { width: 555, height: 368 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        191: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "line-share", baseLinkPath: "https://social-plugins.line.me/lineit/share", dialogDimensions: { width: 555, height: 505 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        ...
        193: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "pinterest-share", baseLinkPath: "http://www.pinterest.com/pin/create/button", dialogDimensions: { width: 750, height: 450 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        194: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "qq-weibo-share", baseLinkPath: "http://v.t.qq.com/share/share.php", dialogDimensions: { width: 658, height: 506 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        195: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "qzone-share", baseLinkPath: "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey", dialogDimensions: { width: 620, height: 645 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        196: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "renren-share", baseLinkPath: "http://www.connect.renren.com/share/sharer", dialogDimensions: { width: 500, height: 315 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        197: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "tumblr-share", baseLinkPath: "http://www.tumblr.com/share/photo", dialogDimensions: { width: 450, height: 432 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        198: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "twitter-favorite", baseLinkPath: "https://twitter.com/intent/favorite", dialogDimensions: { width: 550, height: 420 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        199: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "twitter-reply", baseLinkPath: "https://twitter.com/intent/tweet", dialogDimensions: { width: 550, height: 420 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        200: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "twitter-retweet", baseLinkPath: "https://twitter.com/intent/retweet", dialogDimensions: { width: 550, height: 420 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        201: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "twitter-tweet", baseLinkPath: "https://twitter.com/intent/tweet", dialogDimensions: { width: 550, height: 420 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        ...
        203: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "weibo-share", baseLinkPath: "http://service.weibo.com/share/share.php", dialogDimensions: { width: 650, height: 426 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
        204: [
            function (t, e, i) {
                ...
                e.exports = new n(
                    ...
                    { id: "whatsapp-share", baseLinkPath: "https://api.whatsapp.com/send", dialogDimensions: { width: 555, height: 505 } }
                );
            },
            { "./NetworkAction": 192 },
        ],
                ...
                var R = (function (e) {
                    function i(t) {
                        ...
                        return (
                            ...
                            e._isResponsive && (e._breakpointDetect = new P({ el: e.el, player: e, breakpoints: T, addClass: !0 })),
                            (e._supportsInlineVideo = b || !(w && E)),
                            ...
                            (t.poster || void 0 === t.poster) &&
                                (e._initPoster(t.poster), t.autoplay || void 0 === t.preload || ("none" !== t.preload && "metadata" !== t.preload && !1 !== t.preload) || e._poster.show()),
                            e._bindMethods(),
                            e._addEventListeners(),
                            b && (e._keyboardControl = A({ player: e, threesixty: t.threesixty, keyboardTarget: t.keyboardTarget })),
                    ...
                    return (
                        ...
                        o(i, [
                                    ...
                                    this._videoImpl.on("timeupdate", this._onTimeUpdate),
                                        ...
                                        b
                                            ...
                                            : E &&
                                              ...
                                              w && this.on("fullscreen:change", this._onFullscreenChange)),
                                    ...
                                    this._videoImpl.off("timeupdate", this._onTimeUpdate),
                                        ...
                                        b
                                            ...
                                            : E &&
                                              ...
                                              w && this.off("fullscreen:change", this._onFullscreenChange)),
                            ...
                            },
                            {
                                ...
                                value: function (t, e, i, n) {
                                    if (
                                        ...
                                        t = t.map(
                                            function (t) {
                                                return this._urlOptimizer.getVideoSource(t, o, null, { urlOptimizeHls: this.options.urlOptimizeHls });
                                            }.bind(this)
                                        );
                                    }
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this._controlsFactory
                                        ? (this._instantiateDefaultCustomUIControls(), b ? this.el.appendChild(this._blockade.el) : (this.controls.el.classList.add("mobile"), this.setControls(!0)))
                                        : this.setControls(!0);
                                },
                            },
                            {
                            ...
                            },
                            {
                                key: "_initPoster",
                                value: function (t) {
                                    (this._poster = f({ player: this, video: this._videoImpl, useNativePoster: !1 === this.options.controls, is2x: g, src: t })),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (i.length) for (var n = 0; n < i.length; n++) if (i.start(n) <= t && i.end(n) > t) return (i.end(n) / e) * 100;
                                    return (t / e) * 100;
                                },
                            },
                            {
                                ...
                                value: function () {
                                    this._breakpointDetect
                                        ...
                                        : (this._currentBreakpoint && this.el.classList.remove(this._currentBreakpoint.name),
                                          (this._currentBreakpoint = P.getBreakpointFromElement(this.el, T)),
        ...
        216: [
            function (t, e, i) {
                ...
                e.exports = function (e) {
                    ...
                    e.controlsFactory ||
                        (e.controlsFactory = t("../../ui/ControlsFactory")({ controlsImplementation: e.controlsImplementation, components: e.components, template: e.controlsTemplate })),
                    ...
                    e.threesixty)
                        ? (e.threesixtyElementsTimeoutDuration || (e.threesixtyElementsTimeoutDuration = 3e3), (i = new (t("../ThreeSixtyPlayer"))(e)))
                        : (i = new (t("../Player"))(e));
                    var r = {};
                    return (
                        ...
                        e.sources &&
                            e.sources.length &&
                            (e.autoplay || !e.preload || "auto" === e.preload || !0 === e.preload ? i.load(e.sources, e.textTracks, e.startTime, r) : i.setSrc(e.sources[0])),
                        i
                    );
                };
            },
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        t &&
                                            ...
                                            t.length ? ((this._activeTrack = t[0]), this._addVideoListeners(this._activeTrack)) : ((this._activeTrack = null), this._removeVideoListeners()),
                        ...
                        return (
                            ...
                            n(e, [
                                ...
                                },
                                {
                                    key: "trigger",
                                    value: function (t, i) {
                                        return r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "trigger", this).call(this, t, Object.assign({ type: t }, i || {}));
                                    },
                                },
                                {
                                    key: "destroy",
                    ...
                    if (t instanceof HTMLElement) this.el.appendChild(t);
                        ...
                        (i.src = t.src),
                            ...
                            r.browser.firefox
                                ...
                                : r.os.android
                                ? ((e = this.el.textTracks.length), this.el.appendChild(i), n(this.el.textTracks[e], t.mode || "hidden"))
            ...
            function (t, e, i) {
                ...
                e.exports = function (t) {
                    for (var e, i, r = t.split(/\n/), o = /([\d]{2}:)?[\d]{2}:[\d]{2}.[\d]{3}( --> ){1}([\d]{2}:)?[\d]{2}:[\d]{2}.[\d]{3}/, s = [], a = 0, c = r.length; a < c; a++)
                        if (((i = ""), o.test(r[a]))) {
                            for (
                                (e = r[a].split(" --\x3e "))[0] = e[0].split(":").length < 3 ? "00:" + e[0] : e[0], e[1] = e[1].split(":").length < 3 ? "00:" + e[1] : e[1];
                                ++a && a < c && !o.test(r[a]);
                ...
                (_._initialize = function (t) {
                        ...
                        this._componentCollection = s(
                            ...
                            p(e, {
                                ...
                                pictureInPictureToggle: {
                                    view: {
                                        options: { labels: { initial: this._templateData.pictureinpicture, on: this._templateData.exitpictureinpicture, off: this._templateData.pictureinpicture } },
                                    },
                                },
                            }),
                    ...
                    (_._initUIComponents = function (t) {
                        ...
                        (this.sharingModule = o && o.length ? o[0].behavior.sharingModule : null),
                            ...
                            c && t.enableMainControls && (this.overlays = new l({ el: this.el.querySelector(".ac-video-overlay-container"), player: this._player })),
                            (this._loadingIndicator = new d({ player: this._player, el: this.el.querySelector(".loading-indicator-container") }));
                    }),
                    (_.destroy = function () {
            ...
            function (t, e, i) {
                ...
                e.exports = {
                    ...
                    gotoLive: {
                        ...
                        view: { classDef: o, options: { states: { initial: "not-live", on: "live", off: "not-live" }, labels: { initial: "livestream", on: "livestream", off: "livestream" } } },
                        behavior: { classDef: E },
                    },
                    fullScreen: {
                        ...
                        view: {
                            classDef: o,
                            options: { states: { initial: "fullscreen-unsupported", on: "is-fullscreen", off: "" }, labels: { initial: "fullscreen", on: "exitfullscreen", off: "fullscreen" } },
                        },
                        behavior: { classDef: _ },
                    },
                    toggleMuteVolume: { className: "toggle-mute-volume-button", view: { classDef: o, options: { states: { initial: [], on: ["is-muted"], off: [] } } }, behavior: { classDef: h } },
                    playPauseContainer: {
                    ...
                    captionsToggle: {
                        ...
                        view: { classDef: o, options: { states: { initial: ["no-text-tracks"], on: ["text-tracks-visible"], off: [] } } },
                        behavior: { classDef: p },
                    },
                    ...
                    airplayToggle: {
                        ...
                        view: { classDef: o, options: { states: { initial: ["airplay-unsupported"], on: ["airplay-active"], off: [] } } },
                        behavior: { classDef: w },
                    },
                    ...
                    sharing: { className: "sharing-button", view: { classDef: r, options: { states: { initial: ["sharing-unsupported"], on: ["is-sharing"], off: [] } } }, behavior: { classDef: g } },
                                        ...
                                        var t = this,
                                            ...
                                            i = h(this._player.getTextTracks()).map(function (i) {
                                                ...
                                                i.label &&
                                                    ...
                                                    i.label !== i.language &&
                                                    (n = i.label
                                                        ? i.label + " (" + (l[i.language] || i.language) + ")"
                                                        : (l[i.language] || i.language) + " " + ("description" === i.kind ? " AD" : "")),
                                                    ("showing" === i.mode ||
                                                        (r.length &&
                                                            r.some(function (t) {
                                                                return "showing" === t.mode;
                        ...
                        return (
                            ...
                            n(e, [
                                ...
                                },
                                {
                                    key: "_onClick",
                                    value: function () {
                                        this._player.getMuted() ? (this._player.setMuted(!1), 0 === this._player.getVolume() && this._player.setVolume(0.1)) : this._player.setMuted(!0);
                                    },
                                },
                                {
                                    key: "destroy",
                        ...
                        return (
                            ...
                            n(e, [
                                        ...
                                        t && !isNaN(t) && t !== Math.Infinity
                                            ? this._view.setChapters(
                                                  this._player.getChapters().map(function (e) {
                                                      ...
                                                      return Object.assign({}, e, { startTimeInPercentage: i + "%", startTime: i, "start-time": parseFloat(e["start-time"]) });
                                                  })
                                              )
                                            : this._view.setChapters([]);
                                    },
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return (
                                            (this._cachedDuration && isNaN(this._cachedDuration)) || (this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback)),
                    ...
                    h = (function (t) {
                        function e(t) {
                            ...
                            return (
                                ...
                                (i._span.innerText = c(r, { chaptertitle: n.title, chaptertime: c(l.getTranslation().currenttimetext, { minutes: u, seconds: d }) })),
                            ...
                            n(t, [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        this._player.once(
                                            "controlsready",
                                            function () {
                                                s || (this.compass.addEventListener("mouseenter", this._onCompassMouseEnter), this.compass.addEventListener("mouseleave", this._onCompassMouseLeave)),
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        ...
                                        i > 180
                                            ? ((this.compassRing.style.transform = "rotate(360deg)"), (this.compassField.style.transform = "rotate(360deg)"))
                                            : i < -180
                                            ? ((this.compassRing.style.transform = "rotate(360deg)"), (this.compassField.style.transform = "rotate(360deg)"))
                                            : ((this.compassRing.style.transform = "rotate(0deg)"), (this.compassField.style.transform = "rotate(0deg)"));
                                    },
                                },
                                {
                                    ...
                                    value: function (t) {
                                        this._compassIsRotating ||
                                            (this._player.get360().isAtOrigin
                                                ? (this._360.on(a.ROTATION_UPDATE, this._on360IconUpdate), this._player.get360().oscillateLongitude())
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        (this.compassRing.style.transition = "none"),
                                            ...
                                            this._hovering || ((this.compassField.style.transition = "none"), (this.compassField.style.transform = "rotate(" + t + "deg)"));
                                    },
                                },
                                {
                                ...
                                value: function (t, e) {
                                    !t ||
                                        ...
                                        !this._player.getCurrentSrc() ||
                                            ...
                                            (!e && t && "mousemove" === t.type && this._lastMouseCoords.x === t.screenX && this._lastMouseCoords.y === t.screenY) ||
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        this._userWasRecentlyDragging ||
                                            (t && "mousemove" === t.type && this._lastMouseCoords.x === t.screenX && this._lastMouseCoords.y === t.screenY) ||
                                            this._dragging ||
                                            (this._showCompass(),
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        this._player.controls.compass.el.contains(t.target) && this._userWasRecentlyDragging && t.stopPropagation(),
                                            (t.target !== this._player.controls.playButtonElement.parentElement && t.target !== this._controls.el.firstElementChild) ||
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        t.target !== this._player.controls.compass.compassView &&
                                            (this._controlsVisible() ? this._isActiveArea(t.target) || (this._hideControls(), this._hideCompass()) : this._onUserInteraction(t));
                                    },
                                },
                                {
                                    key: "_onTouchStart",
                                        ...
                                        (this.el.innerHTML = ""),
                                            t.forEach(function (t) {
                                                ...
                                                n.setAttribute("role", "radio"),
                                                    t.enabled
                                                        ? (n.classList.add("enabled"), n.setAttribute("aria-checked", "true"), n.setAttribute("tabIndex", 0), (i = n))
        ...
        257: [
            function (t, e, i) {
                ...
                var n = t("@marcom/ac-slider").Slider,
                    ...
                    o = function (t, e) {
                        if (((this.el = t), (this._min = e.min || 0), (this._max = e.max || 1), e.mixins)) for (var i = e.mixins.slice(0); i.length; ) Object.assign(this, i.pop());
                                    ...
                                    value: function (t) {
                                        this._currentState && this._currentState !== t && this._states[this._currentState].length && this.el.classList.remove(this._states[this._currentState]),
                                            ...
                                            this._labels &&
                                                ...
                                                ((this._focusTarget.value = this._labels[this._currentState]), this._focusTarget.setAttribute("aria-label", this._labels[this._currentState])),
                        ...
                        return (
                            ...
                            n(e, [
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        if (t.target.classList.contains("controls-progress-indicator"))
                                            return this._triggerKeyboardInteraction(), void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onLeftArrowDown", this).call(this, t);
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        if (t.target.classList.contains("controls-progress-indicator"))
                                            return this._triggerKeyboardInteraction(), void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onRightArrowDown", this).call(this, t);
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        if (t.target.classList.contains(s[0]) || t.target.classList.contains(s[1]))
                                            return this._triggerKeyboardInteraction(), void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onUpArrowDown", this).call(this, t);
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        if (t.target.classList.contains(s[0]) || t.target.classList.contains(s[1]))
                                            return this._triggerKeyboardInteraction(), void r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_onDownArrowDown", this).call(this, t);
                        ...
                        return (
                            n(t, [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        (!this._isPaused && this._started) ||
                                            ((this._isPaused = this._player.getPaused()), this._isPaused || (this._started = !0), (this._isSeeking = !1), this._checkLoadingState(!0));
                                    },
                                },
                                {
                                    key: "_onSeeking",
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        this._isPaused ||
                                            (!0 !== t && this._started ? (clearTimeout(this._showTimeout), (this._showTimeout = setTimeout(this._doShow, this._showTimeoutDelay))) : this._doShow());
                                    },
                                },
                                {
            ...
            function (t, e, i) {
                ...
                var n = t("../templates/overlays/trickplay-overlay.html"),
                    ...
                    c = function (t) {
                        (this._player = t.player),
                            ...
                            (this._thumbnailHandler = new o({ el: this.el.querySelector(".ac-video-trickplay-image"), player: this._player, numberOfImages: t.numberOfImages })),
                ...
                (l._initPointerTracking = function () {
                    ...
                    (l._getDuration = function () {
                        return (
                            (this._cachedDuration && isNaN(this._cachedDuration)) || (this._cachedDuration = Math.max(0, this._player.getDuration() - this._liveStreamLookback)), this._cachedDuration
                        );
                    }),
                    ...
                    (l.setData = function (t) {
                        (this.el.style.opacity = "0"),
                            this._canPlayThroughHander &&
                                (this._player.off("canplaythrough", this._canPlayThroughHander), this._player.off("playing", this._canPlayThroughHander), (this._canPlayThroughHander = null)),
                            ...
                            var e = this._loadImage(this._imgUrl).then(
                                function () {
                                    this._imageLoadPromise === e &&
                                        ((this.el.style.backgroundImage = 'url("' + this._imgUrl + '")'), (this._imageLoadPromise = null), this.el.classList.remove("hidden"));
                                }.bind(this)
                            );
                            this._imageLoadPromise = e;
                        }
                ...
                (m._initializeElement = function (t, e) {
                    ...
                    (m.setData = function (t) {
                        if (t) {
                            if (
                                ...
                                u && !1 !== t.analytics && t.videoid)
                            )
                                try {
                                    this._initAnalyticsAttributes(t), this._analyticsObserver || (this._analyticsObserver = u({ context: this.el }));
                                } catch (t) {
                                    o("ac-analytics-share failed to load, are you sure you've included it?");
                                }
                    ...
                    (m._doSocialShare = function (t) {
                        (this._clickedShareButton = null),
                            ...
                            a.create(t, { url: this._sharingUrl, title: this._title });
                    }),
                    (m._showTextArea = function (t) {
                        t
                            ? (this._container.classList.add("textarea-active"), s(this._copyTextArea), p || this._copyTextArea.setAttribute("readonly", ""))
                            : (this._container.classList.remove("textarea-active"),
                              this._copyLinkButton.classList.remove("active"),
                              this._copyEmbedCodeButton.classList.remove("active"),
                        ...
                        formatTime: function (t, e, i) {
                            return isNaN(t)
                                ...
                                : ((t = this.splitTime(
                                  ...
                                  n(e >= 3600 ? "{PN}{hours}:{minutes}:{seconds}" : "{PN}{minutes}:{seconds}", { PN: t.negativeModifier, hours: t.hours, minutes: t.minutes, seconds: t.seconds }));
                        },
            ...
            function (t, e, i) {
                ...
                e.exports = {
                    ...
                    getCaptionsSource: function (t) {
                        return t.match(h) ? (t.match(o) ? { src: t.replace(o, "_cc.vtt"), srclang: "en" } : t.match(r) ? { src: t.replace(r, "_cc.vtt"), srclang: "en" } : null) : null;
                    },
                        ...
                        return (
                            ...
                            n(e, [
                                    ...
                                    value: function (t, e) {
                                        if (o) {
                                            this._initHls(),
                                                ...
                                                this._hls.on(o.Events.AUDIO_TRACK_SWITCHED, this._forwardAudioTrackChangeEvent),
                                                (this._src = t[0]);
                                            var i = function () {
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        return "vnd.apple.mpegURL" === t
                                            ? r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "canPlayType", this).call(this, "video/mp4")
                                            : r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "canPlayType", this).call(this, t);
                                    },
                                },
                                {
                                    ...
                                    value: function (t, e) {
                                        !0 === e.fatal &&
                                            ("fragLoadError" === e.details
                                                ? s("HLS JS threw a fatal fragLoadError error, but we'll try to let it recover because it probably can if the network/stream recovers")
                                    ...
                                    value: function () {
                                        (this._shouldPlay = !0),
                                            this._manifestParsed &&
                                                (this._mediaAttached || this.load([this._src]), r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "play", this).call(this));
                                    },
                                },
                                {
                                    key: "pause",
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return (
                                            (void 0 !== this._hls.desiredRate && 1 === this._hls.desiredRate && this._hls.desiredRate !== this._hls.effectiveRate) ||
        ...
        306: [
            function (t, e, i) {
                ...
                e.exports = function (t, e) {
                    var i = 1;
                    return e && (i = t.getBoundingClientRect().width / t.offsetWidth), { width: t.scrollWidth * i, height: t.scrollHeight * i };
                };
            },
            {},
        ],
        ...
        308: [
            function (t, e, i) {
                ...
                e.exports = function (t, e) {
                    var i = typeof t;
                    return (e = "string" === i ? t : e), (t = t && "string" !== i && t !== window ? t : document.documentElement), e && /^[xy]$/i.test(e) ? n(t, e) : { x: n(t, "x"), y: n(t, "y") };
                };
            },
            {},
        ],
        ...
        326: [
            function (t, e, i) {
                ...
                function o(t, e) {
                    ...
                    "string" == typeof n && (n = [n]);
                    for (var r, o = n.length, s = 0; s < o; s++) if ((r = e.match(((i = n[s]), new RegExp(i + "[a-zA-Z\\s/:]+([0-9_.]+)", "i")))) && r.length > 1) return r[1].replace(/_/g, ".");
                    return !1;
                }
                function s(t, e, i) {
        ...
        328: [
            ...
            { "./ac-event-emitter/EventEmitter": 329, dup: 96 },
        ],
        329: [
            function (t, e, i) {
            ...
            function (t, e, i) {
                ...
                (l._bindAnchors = function (t) {
                    ...
                    (l._getEventData = function () {
                        return { currentTime: this.player.getCurrentTime(), playerType: this.playerType || "html5", videoType: this.videoType || null };
                    }),
                    (l._createObserver = function (t) {
                        var e;
                        return n && n.observer && n.observer.Video && (e = new n.observer.Video(t, { dataAttribute: this.options.dataAttribute })), e;
                    }),
                        ...
                        (this._ended = !0),
                            !this.player.isPictureInPicture() && this._closeOnEnd
                                ...
                                : this.player.isPictureInPicture() &&
                                  (this.player.setPictureInPicture(!1), this.modal.modalElement.classList.remove("ac-modal-video-pip"), this._closeOnEnd || (this.modal.open(), this._bindWillClose()));
                    }),
                    (a._onPipModeChanged = function () {
                        this._ended ||
                            (this.player.isPictureInPicture() && this._isModalOpen()
                                ? (this._unBindWillClose(), this.modal.modalElement.classList.add("ac-modal-video-pip"), this.modal.close())
                                : this._isModalOpen() ||
                                  (this.modal.modalElement.classList.remove("ac-modal-video-pip"),
                                  !this._pauseTime || Date.now() - this._pauseTime > 400 ? (this._bindWillClose(), this.modal.open()) : this._resetVideo()));
                    }),
