...
})(
    {
            ...
            function (e, t, n) {
                ...
                (p._setup = function () {
                    for (var e = [c.ARROW_DOWN, c.ARROW_RIGHT], t = [c.ARROW_UP, c.ARROW_LEFT], n = [c.ENTER, c.SPACEBAR], r = 0; r < e.length; r++)
                        this.addNavkey(e[r], this._arrowDown.bind(this, !0)), this.addNavkey(t[r], this._arrowDown.bind(this, null)), this.addNavkey(n[r], this.selectOption);
                    this._setupNavItems();
                }),
                    ...
                    (p._arrowDown = function (e, t, n) {
                        t.preventDefault(),
                            ...
                            n || this.trigger(h.ONFOCUS, { event: t, index: this.focusedNavItemIndex, el: this._navItems[this.focusedNavItemIndex] });
                    }),
                    (p.selectOption = function (e, t) {
                        ...
                        n > -1 && document.activeElement !== this._navItems[this.focusedNavItemIndex] && (this.focusedNavItemIndex = n),
                            ...
                            t || this.trigger(h.ONSELECT, { event: e, index: this.selectedNavitemIndex, el: this._navItems[this.selectedNavitemIndex] });
                    }),
                    ...
                    (p.setSelectedItemByIndex = function (e, t) {
                        this._allowMultiSelection || isNaN(this.selectedNavitemIndex) || this._navItems[this.selectedNavitemIndex].setAttribute(this._state, "false"),
                            ...
                            t || this.trigger(h.ONSELECT, { event: null, index: this.focusedNavItemIndex, el: this._navItems[this.focusedNavItemIndex] });
                    }),
                ...
                (l._bindEvents = function () {
                    ...
                    (l._clickProxy = function (e, t, n, r) {
                        ...
                        o.indexOf(i) < 0 && s("element's role is not set to any of the following " + o.join(", ")),
                            r
                                ? (e.removeEventListener("keydown", this._handleKeydown), this._removeCallback(e, t, n))
                                : (e.addEventListener("keydown", this._handleKeydown), this._addCallback(e, t, n));
                    }),
                    (l._hoverProxy = function (e, t, n, r) {
                        r
                            ? (e.removeEventListener("focus", this._handleHover, !0), e.removeEventListener("blur", this._handleHover, !0), n && this._removeCallback(e, t, n))
                            : (e.addEventListener("focus", this._handleHover, !0), e.addEventListener("blur", this._handleHover, !0), n && this._addCallback(e, t, n));
                    }),
        ...
        24: [
            function (e, t, n) {
                ...
                t.exports = function (e) {
                    ...
                    if (e) for ((t = document.createElement("div")).innerHTML = e; t.firstChild; ) n.appendChild(t.firstChild);
                    return n;
                };
            },
            {},
        ...
        43: [
            function (e, t, n) {
                ...
                t.exports = function (e, t) {
                    return (
                        r.insertNode(e, !0, "insertFirstChild", "newNode"),
            ...
            function (e, t, n) {
                ...
                function o() {
                    ...
                    try {
                        "cookie" in t &&
                            n.cookieEnabled &&
                            ((t.cookie = "ac_feature_cookie=1"), (e = -1 !== t.cookie.indexOf("ac_feature_cookie")), (t.cookie = "ac_feature_cookie=; expires=Thu, 01 Jan 1970 00:00:01 GMT;"));
                    } catch (e) {}
                    return e;
                }
                (t.exports = i(o)), (t.exports.original = o);
        ...
        50: [
            function (e, t, n) {
                ...
                var r = e(95),
                    i = e(70);
                function o() {
                    return ["linear-gradient(to bottom right, #9f9, white)", "linear-gradient(top left, #9f9, white)", "gradient(linear, left top, right bottom, from(#9f9), to(white))"].some(
                        function (e) {
                ...
                function o() {
                    ...
                    try {
                        "sessionStorage" in e &&
                            ...
                            (e.sessionStorage.setItem("ac_feature", "test"), (t = !0), e.sessionStorage.removeItem("ac_feature", "test"));
                    } catch (e) {}
                    return t;
                }
                (t.exports = i(o)), (t.exports.original = o);
        ...
        71: [
            function (e, t, n) {
                ...
                function s() {
                    ...
                    return s
                        ? s.replace(t, function (n, s) {
                              var l,
                                  c = s.replace(t, "$1").trim();
                              return (
                                  "@root." === c.substr(0, 6) && (l = i.get(r.data.root, c.substr(6))),
        ...
        72: [
            function (e, t, n) {
                ...
                t.exports = class extends r {
                    ...
                    destroy() {
                        return (
                            this._context.removeEventListener("keydown", this._DOMKeyDown, !0),
            ...
            function (e, t, n) {
                ...
                var i = {
                    ...
                    o = {
                        ...
                        after: {
                            cite: { regex: "\\[@(.+?)\\]", replace: "<cite>$1</cite>" },
                            sub: { regex: "\\^\\^(.+?)\\^\\^", replace: "<sub>$1</sub>" },
                            sup: { regex: "\\^(.+?)\\^", replace: "<sup>$1</sup>" },
                            data: { regex: "\\{\\{DATA:(.+?)\\}\\}", replace: "<data>$1</data>" },
                            nowrap: { regex: "\\{\\{(.+?)\\}\\}", replace: '<span class="nowrap">$1</span>' },
                            nbsp: { regex: ":nbsp:", replace: "&nbsp;" },
                            wj: { regex: ":wj:", replace: "&#x2060;" },
                            shyp: { regex: ":shyp:", replace: "&shy;" },
                            nbhyp: { regex: ":nbhyp:", replace: "&#x2011;" },
                            wbr: { regex: ":wbr:", replace: "&#8203;<wbr />" },
                            lrm: { regex: ":lrm:", replace: "&lrm;" },
                            rlm: { regex: ":rlm:", replace: "&rlm;" },
                            br: { regex: ":br(\\(.*?\\))?:", replace: i.br },
                            styleguide: { regex: "([^ ])/>", replace: "$1 />" },
                        },
                    };
                function s(e, t) {
                    return (
                ...
                t.exports = function () {
                    ...
                    return (
                        ...
                        e.forEach(function (e) {
                            if (null != e) for (var n in e) r.call(e, n) && (t[n] = e[n]);
                        }),
                        t
                    );
                };
                    ...
                    try {
                        ...
                        Array.prototype.slice = function (t, n) {
                            ...
                            if ((n < 0 && (l = s + n), (i = l - (a = a >= 0 ? a : s + a)) > 0))
                                if (((o = new Array(i)), this.charAt)) for (r = 0; r < i; r++) o[r] = this.charAt(a + r);
                                else for (r = 0; r < i; r++) o[r] = this[a + r];
                            return o;
                        };
                    }
                })();
        ...
        93: [
            function (e, t, n) {
                ...
                t.exports = function e(t, n) {
                    ...
                    if (t in i) for (u = 0; u < i[t].length; u++) if (((l = i[t][u]), r(l.toLowerCase(), n))) return (c[t] = l);
                    for (u = 0; u < s.evt.length; u++) if (((l = s.evt[u] + t), r(l, n))) return s.reduce(u), (c[t] = l);
        ...
        94: [
            function (e, t, n) {
                ...
                t.exports = function (e) {
                    ...
                    for (
                        o = i(), n = (e = s(e)).charAt(0).toUpperCase() + e.substring(1), t = "filter" === e ? ["WebkitFilter", "filter"] : (e + " " + a.dom.join(n + " ") + n).split(" "), c = 0;
                        c < t.length;
                        c++
                    )
            ...
            function (e, t, n) {
                ...
                (a.prototype = {
                    ...
                    load: function () {
                        var e, t;
                        return (
                            !(!(e = i.best()) || "function" != typeof e.getItem) &&
                            ((t = e.getItem(this.key())), this.__updateState(s.decode(t)), (null !== t && !this.hasExpired()) || (this.remove(), !1))
                        );
                    },
                    remove: function () {
                    ...
                    __updateState: function (e) {
                        var t, n;
                        for (t in (null === e && (e = { checksum: null, expirationDate: null, metadata: null, value: null }), e))
                ...
                var r,
                    ...
                    o = {
                        ...
                        setItem: function (e, t, n) {
                            var r = this.element();
                            return (
                                r.setAttribute(e, t), !1 === n && (n = new Date(Date.now() + 864e5)), n && "function" == typeof n.toUTCString && (r.expires = n.toUTCString()), r.save("ac-storage"), !0
                            );
                        },
                        removeItem: function (e) {
                            var t = this.element();
            ...
            function (e, t, n) {
                ...
                (n.__esModule = !0),
                    ...
                    (n.preparePartialBlock = function (e, t, n, r) {
                        return s(e, n), { type: "PartialBlockStatement", name: e.path, params: e.params, hash: e.hash, program: t, openStrip: e.strip, closeStrip: n && n.strip, loc: this.locInfo(r) };
                    });
                var r,
                    i = e(142),
                        ...
                        return (
                            ...
                            r
                                ...
                                : ((h.compiler = JSON.stringify(h.compiler)),
                                  ...
                                  t.srcName ? ((h = h.toStringWithSourceMap({ file: t.destName })).map = h.map && h.map.toString()) : (h = h.toString())),
                            h
                        );
                    },
                    preamble: function () {
                    ...
                    compileChildren: function (e, t) {
                        for (var n = e.children, r = void 0, i = void 0, o = 0, s = n.length; o < s; o++) {
                            ...
                            if (null == a) {
                                ...
                                (r.index = a.index), (r.name = "program" + a.index), (this.useDepths = this.useDepths || a.useDepths), (this.useBlockParams = this.useBlockParams || a.useBlockParams);
                        }
                    },
                                ...
                                for (var p, d, f, g, m, v, y, _, b, x, w = {}; ; ) {
                                    if (
                                        ...
                                        this.defaultActions[f]
                                            ...
                                            : (null == p && ((x = void 0), "number" != typeof (x = t.lexer.lex() || 1) && (x = t.symbols_[x] || x), (p = x)), (g = o[f] && o[f][p])),
                                        ...
                                        if (!c) {
                                            ...
                                            (k = this.lexer.showPosition
                                                ? "Parse error on line " + (a + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + b.join(", ") + ", got '" + (this.terminals_[p] || p) + "'"
                                                : "Parse error on line " + (a + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'")),
                                                this.parseError(k, { text: this.lexer.match, token: this.terminals_[p] || p, line: this.lexer.yylineno, loc: u, expected: b });
                                        }
                                    }
                                    ...
                                    switch (g[0]) {
                                        ...
                                        case 2:
                                            if (
                                                ...
                                                return m;
                                            y && ((n = n.slice(0, -1 * y * 2)), (r = r.slice(0, -1 * y)), (i = i.slice(0, -1 * y))),
        ...
        137: [
            function (e, t, n) {
                ...
                (s.prototype = new o.default()),
                    ...
                    (s.prototype.BlockStatement = s.prototype.DecoratorBlock =
                        function (e) {
                            var t = "";
                            return (
                    ...
                    try {
                        n &&
                            ...
                            Object.defineProperty
                                ? (Object.defineProperty(this, "column", { value: a, enumerable: !0 }), Object.defineProperty(this, "endColumn", { value: l, enumerable: !0 }))
                            ...
                            e.registerHelper("each", function (e, t) {
                                ...
                                function p(t, n, r) {
                                    u && ((u.key = t), (u.index = n), (u.first = 0 === n), (u.last = !!r), h && (u.contextPath = h + t)),
                                        (c += i(e[t], { data: u, blockParams: o.blockParams([e[t], t], [h + t, null]) }));
                                }
                                if (
                                    ...
                                    if (o.isArray(e)) for (var d = e.length; l < d; l++) l in e && p(l, l, l === e.length - 1);
            ...
            function (e, t, n) {
                ...
                (n.default = function (e) {
                    e.registerHelper("with", function (e, t) {
                        ...
                        var r = t.data;
                        return (
                            t.data && t.ids && ((r = i.createFrame(t.data)).contextPath = i.appendContextPath(t.data.contextPath, t.ids[0])),
                            n(e, { data: r, blockParams: i.blockParams([e], [r && r.contextPath]) })
                        );
                    });
                }),
                    (t.exports = n.default);
                ...
                (function (e) {
                    (function () {
                        !(function (e) {
                                    ...
                                    for (e = e.replace(/^ +$/gm, ""); e; )
                                        if (
                                            ...
                                            for (
                                                e = e.substring(o[0].length),
                                                    d = (s = o[2]).length > 1,
                                                    this.tokens.push({ type: "list_start", ordered: d, start: d ? +s : "" }),
                                                    n = !1,
                                                ...
                                                (c = (l = o[u]).length),
                                                    ...
                                                    this.options.smartLists &&
                                                        u !== p - 1 &&
                                                        (s === (a = r.bullet.exec(o[u + 1])[0]) || (s.length > 1 && a.length > 1) || ((e = o.slice(u + 1).join("\n") + e), (u = p - 1))),
                                                    (i = n || /\n\n(?!\s*$)/.test(l)),
                            ...
                            function d(e, t) {
                                return (
                                    f[" " + e] || (/^[^:]+:\/*[^/]*$/.test(e) ? (f[" " + e] = e + "/") : (f[" " + e] = e.replace(/[^/]*$/, ""))),
                                    (e = f[" " + e]),
                            ...
                            (o._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
                                ...
                                (o.breaks = v({}, o.gfm, { br: p(o.br).replace("{2,}", "*").getRegex(), text: p(o.gfm.text).replace("{2,}", "*").getRegex() })),
                                (s.rules = o),
                                ...
                                (s.prototype.output = function (e) {
                                    for (var t, n, r, i, o = ""; e; )
                                        if ((i = this.rules.escape.exec(e))) (e = e.substring(i[0].length)), (o += i[1]);
                                            ...
                                            (e = e.substring(i[0].length)), (r = "@" === i[2] ? "mailto:" + (n = u(this.mangle(i[1]))) : (n = u(i[1]))), (o += this.renderer.link(r, null, n));
                                ...
                                (a.prototype.code = function (e, t, n) {
                                    ...
                                    return t
                                        ? '<pre><code class="' + this.options.langPrefix + u(t, !0) + '">' + (n ? e : u(e, !0)) + "\n</code></pre>\n"
                                        : "<pre><code>" + (n ? e : u(e, !0)) + "\n</code></pre>";
                                }),
                                ...
                                (c.prototype.parse = function (e) {
                                    (this.inline = new s(e.links, this.options)), (this.inlineText = new s(e.links, v({}, this.options, { renderer: new l() }))), (this.tokens = e.reverse());
                            ...
                            function y(e, t, n) {
                                ...
                                if (n || "function" == typeof t) {
                                    ...
                                    try {
                                        ...
                                        if (((e.message += "\nPlease report this to https://github.com/markedjs/marked."), (t || y.defaults).silent))
                                            return "<p>An error occurred:</p><pre>" + u(e.message + "", !0) + "</pre>";
                                        throw e;
                                    }
                            }
                            (m.exec = m),
                                (y.options = y.setOptions =
                                    function (e) {
                    ...
                    window.matchMedia = function (r) {
                        ...
                        return (
                            (s.addListener = function (e) {
                                t && (n || ((n = !0), window.addEventListener("resize", o, !0)), 0 === l && (l = i.push({ mql: s, listeners: a })), a.push(e));
                            }),
                        ...
                        if (s >= 0) {
                            ...
                            if (void 0 === e.column)
                                for (var l = a.originalLine; a && a.originalLine === l; )
                                    o.push({ line: r.getArg(a, "generatedLine", null), column: r.getArg(a, "generatedColumn", null), lastColumn: r.getArg(a, "lastGeneratedColumn", null) }),
                    ...
                    (c.fromSourceMap = function (e, t) {
                        ...
                        for (var l = e._mappings.toArray().slice(), h = (n.__generatedMappings = []), p = (n.__originalMappings = []), d = 0, f = l.length; d < f; d++) {
                            ...
                            (m.generatedLine = g.generatedLine),
                                ...
                                g.source &&
                                    ((m.source = s.indexOf(g.source)), (m.originalLine = g.originalLine), (m.originalColumn = g.originalColumn), g.name && (m.name = i.indexOf(g.name)), p.push(m)),
                                h.push(m);
                        }
                    ...
                    (c.prototype.generatedPositionFor = function (e) {
                        ...
                        if (i >= 0) {
                            ...
                            if (o.source === n.source)
                                return { line: r.getArg(o, "generatedLine", null), column: r.getArg(o, "generatedColumn", null), lastColumn: r.getArg(o, "lastGeneratedColumn", null) };
                        }
                        ...
                        for (var e, t, n, o, s = 0, a = 1, l = 0, c = 0, u = 0, h = 0, p = "", d = this._mappings.toArray(), f = 0, g = d.length; f < g; f++) {
                            ...
                            (e += r.encode(t.generatedColumn - s)),
                                ...
                                null != t.source &&
                                    ...
                                    (l = t.originalColumn),
                                    null != t.name && ((n = this._names.indexOf(t.name)), (e += r.encode(n - u)), (u = n))),
                                (p += e);
                        }
                        return p;
                    }),
            ...
            function (e, t, n) {
                ...
                (a.fromStringWithSourceMap = function (e, t, n) {
                    ...
                    return (
                        ...
                        l < s.length && (p && d(p, c()), r.add(s.splice(l).join(""))),
                                ...
                                for (var c = 0, u = e.length; c < u; c++)
                                    10 === e.charCodeAt(c)
                                        ? (t.line++,
                                          ...
                                          c + 1 === u
                                              ? ((o = null), (i = !1))
                                              : i && n.addMapping({ source: r.source, original: { line: r.line, column: r.column }, generated: { line: t.line, column: t.column }, name: r.name }))
                                        : t.column++;
                            }),
                            ...
                            (0, o.default)(e, [
                                {
                                    ...
                                    value: function () {
                                        ...
                                        e || t
                                            ? ((this._forceLoad = !0),
                                              e
                                                  ? ((this._geoCookieLocale = e), (this._userLangLocale = this._getLocaleCode(this._geoCookieLocale, this._userLang)))
                                                  : t && (this._userLangLocale = "true" === t ? "en-US" : t))
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        var e =
                                                "https://www.apple.com/" === document.querySelector("[hreflang=en-US]").href ||
                                                null !== document.querySelector("[hreflang=en-US]").href.match(/.com\/$/im),
                                            t = null !== document.querySelector("html[lang=zh-CN]");
                                        e && !t
                                            ? document.documentElement.classList.toggle(this._selectors.fixedClass)
                                            : e && t && document.documentElement.classList.toggle(this._selectors.cnHpClass);
                                    },
                                },
                                {
                                    ...
                                    value: function () {
                                        "ontouchstart" in document.documentElement
                                            ? document.addEventListener("touchstart", this._handleDropdownClickAway)
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        this.storageItem.setValue({ dismissals: 0 }),
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        (this._arrowNavigation = new l(this._dropdownList, { selector: "li", state: "aria-selected" })),
                                ...
                                },
                                {
                                    key: "_onRAFDraw",
                                    value: function () {
                                        this._elHeight !== this._lastHeight && ((document.documentElement.style["margin-top"] = this._elHeight), (this.el.style.top = "-".concat(this._elHeight))),
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        s &&
                                            new s(this._eventEmitterMicro).track({
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        document.documentElement.classList.remove(this._selectors.visibleClass),
                                            ...
                                            (this.el.style.top = ""),
                                            "ontouchstart" in document.documentElement
                                                ? document.removeEventListener("touchstart", this._handleDropdownClickAway)
                                                : document.removeEventListener("click", this._handleDropdownClickAway),
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        n || r
                                            ? n || !r || i || "click" !== e.type
                                                ? n || !r || i || "touchstart" !== e.type || document.activeElement.blur()
                                                : document.body.focus()
                                            : this._closeDropdown();
                                    },
                                },
                                    ...
                                    value: function (e) {
                                        e.currentTarget === this._firstFocusableMenuEl && !0 === e.shiftKey && (e.stopPropagation(), e.preventDefault(), this._closeDropdown()),
                                            e.currentTarget === this._lastFocusableMenuEl &&
                                                !1 === e.shiftKey &&
                                                (e.stopPropagation(), e.preventDefault(), this._closeDropdown(), this._continueButton.focus());
                                    },
                                },
                                {
                                    key: "_getCookie",
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var t = [];
                                        return (
                                            document.querySelectorAll("[hreflang]").forEach(function (n) {
                                                var r = n.hreflang,
