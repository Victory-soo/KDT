!(function t(e, i, n) {
...
})(
    {
        ...
        15: [
            function (t, e, i) {
                "use strict";
                e.exports = { EventEmitterMicro: t(16) };
            },
            { 16: 16 },
        ],
        16: [
        ...
        18: [
                ...
                var n = t(14),
                    ...
                    _ = function (t, e) {
                        ...
                        (e = Object.assign({}, d, e)),
                            ...
                            this.stickyEnabled && (this._sticky = new c(this.el, e)),
                ...
                (m._getStickyEnabled = function () {
                    ...
                    (m._initializeMenu = function () {
                        ...
                        t &&
                            ...
                            window.addEventListener(n, this._closeMenu),
                            window.addEventListener("orientationchange", this._closeMenu),
                            new u(this._selectors.clickAwaySelector).on("click", this._closeMenu),
                    ...
                    (m._onScroll = function (t) {
                        ...
                        this.menu.isOpen() &&
                            ...
                            this._menuCollapseOnScroll
                                ? (this._closeMenu(), this.menu.anchorOpen.focus())
                                : ((e = t.target), (n(e, l) && s(e, this._selectors.traySelector, !0)) || (t.preventDefault(), (this._menuCollapseOnScroll = !0))));
                    }),
            ...
            { 1: 1, 10: 10, 14: 14, 19: 19, 20: 20, 21: 21, 42: 42, 45: 45, 54: 54 },
        ],
        19: [
            function (t, e, i) {
                "use strict";
            ...
            function (t, e, i) {
                ...
                var n = t(15).EventEmitterMicro,
                    ...
                    c = function (t, e) {
                        n.call(this),
                            ...
                            "acStore" in window && (window.acStore.getStorefront().then(this._updatePlaceholderOffset), window.acStore.on("storefrontChange", this._updatePlaceholderOffset));
                    };
                ...
                (c.prototype.constructor = c),
                    ...
                    (l._updatePosition = function () {
                        a("y") > this._placeholderOffset
                            ? this.stuck ||
                              (this.el.classList.add(this._selectors.stuckClassName), this.placeholder.classList.add(this._selectors.stuckClassName), (this.stuck = !0), this.trigger("stuck"))
                            : this.stuck &&
                              (this.el.classList.remove(this._selectors.stuckClassName), this.placeholder.classList.remove(this._selectors.stuckClassName), (this.stuck = !1), this.trigger("unstuck"));
                    }),
                    (e.exports = c);
            },
            { 11: 11, 15: 15, 41: 41, 45: 45, 53: 53 },
        ],
        22: [
            function (t, e, i) {
                "use strict";
                ...
                e.exports = function (t) {
                    ...
                    for (
                        r = s(), i = (t = a(t)).charAt(0).toUpperCase() + t.substring(1), e = "filter" === t ? ["WebkitFilter", "filter"] : (t + " " + o.dom.join(i + " ") + i).split(" "), c = 0;
                        c < e.length;
                        c++
                    )
            ...
            function (t, e, i) {
                ...
                function p(t, e) {
                    n.call(this),
                        ...
                        (this._resizing = !1),
                        (this._mediaQueryLists = { resolution: { retina: window.matchMedia(c) }, orientation: { portrait: window.matchMedia(u), landscape: window.matchMedia(l) } }),
