    ...
    return (function (t) {
        ...
        function (t, e, i) {
            ...
            const r = i(26),
                ...
                n = (t, e) =>
                    ((t) => document.querySelectorAll(`meta[name="ac:${t}-alias"]`))(t).forEach((t) => {
                        const [i, r] = (t.getAttribute("content") || "").split("=");
                        i && r && ((e.aliases = e.aliases || {}), (e.aliases[i] = r));
                    }),
                a = (t, e) =>
                    ((t) => document.querySelectorAll(`meta[name="ac:${t}-disable"]`))(t).forEach((t) => {
        ...
        function (t, e) {
            ...
            t.exports = function (t, e) {
                if (t.switch) {
                    const r = t.switch.includes("true");
                    if (r) return;
                    if (!r) {
                        const r = t.switch,
                            s = {
                                ...
                                ...(function (t, e, r) {
                                    ...
                                    return i(
                                        t.filter((t) => !s.includes(t)).reduce((t, e) => ({ ...t, [e]: e }), {}),
                                        r
                                    );
                                })(e, t, r),
                            };
        ...
        function (t, e, i) {
            ...
            t.exports = class extends n {
                ...
                formatResponseItem(t, e) {
                    let i = null;
                    return (
                        this.options.dummyPrices && "UNKNOWN" === e.type && ((e = r(t, "unknown")), this.itemsWithDummyPrice.push(t)),
                        (i = new s(e)),
                        i.price && 999999 === i.price.value && this.itemsWithDummyPrice.push(t),
                        i
                    );
                }
        ...
        function (t, e, i) {
            ...
            t.exports = function (t, e) {
                const i = t % 1 == 0 ? 0 : 2;
                return t > 9999 ? t.toLocaleString(e, { minimumFractionDigits: i, maximumFractionDigits: i }) : t.toFixed(i);
            };
        },
        function (t, e, i) {
            "use strict";
        ...
        function (t, e, i) {
            ...
            t.exports = function (t, e) {
                Object.entries(e).forEach(([e, i]) => {
                    t[e] || Object.defineProperty(t, e, { enumerable: !0, value: "object" == typeof i ? Object.freeze(JSON.parse(JSON.stringify(i))) : i });
                });
            };
        },
        function (t, e, i) {
        ...
        function (t, e, i) {
            ...
            const r = i(56),
                ...
                o = i(18),
                c = i(3),
                u = { endpoint: null, aliases: null, timeout: 5, dummyPrices: !1, method: "GET", switch: null };
            t.exports = class {
                constructor(t = [], e = {}) {
                ...
                _processOptions(t) {
                    if (!(t = Object.assign({}, u, t)).endpoint) throw new o.ConfigurationError({ type: "endpoint" });
        ...
        function (t, e, i) {
            "use strict";
            t.exports = { ConfigurationError: i(60), ServiceNotFoundError: i(61), ServiceUnavailableError: i(62), TimeoutError: i(63), InvalidDataError: i(4), UnexpectedError: i(64) };
        },
        function (t, e, i) {
            "use strict";
            const r = i(2),
        ...
        function (t, e, i) {
            const { applyPrices: r } = i(24);
            function s(t) {
                return (e) => {
                    const i = Boolean(e) ? t + "Error" : t + "Complete",
                        r = new CustomEvent(i, { detail: { error: e } });
        ...
        function (t, e, i) {
            "use strict";
            t.exports = Object.assign({ applyPrices: i(25), fetchEduProducts: i(6), fetchProducts: i(19), fetchTradeIns: i(20), Product: i(13), TradeIn: i(21) }, i(18));
        },
        function (t, e, i) {
            "use strict";
            const r = i(6),
            ...
            t.exports = new (class {
                ...
                fetchProductInfo(t, e = {}) {
                    ...
                    return a(t).then((a) => {
                        ...
                        return t === m ? (c = s(u, e)) : t === d ? (c = r(u, e)) : t === f ? (c = n(u, e)) : (i = "API not supported"), i || c.then((t) => ({ response: t, options: o }));
                    });
                }
                ...
                checkForSingleElementIDs(t, e, i, r) {
                    const s = r.dataset[`${t}${c}`],
                        n = i.products[s];
                    s === this.getproductID(e, t) &&
                        ((((n && !this.checkForProductNameKey(n, n.productName) && !this.checkForTypeKey(n, n.type)) || e.innerText) && e.innerText) || (r.style.display = "none"));
                }
                ...
                hideMultipleElements(t, e) {
                    this[`${e}${h}`].forEach((i) => {
                        const r = i.dataset[`${e}${u}`]
                            .split(",")
                            .every((e) => !t.products[e] || this.checkForProductNameKey(t.products[e], t.products[e].productName) || this.checkForTypeKey(t.products[e], t.products[e].type));
        ...
        function (t, e, i) {
            "use strict";
            t.exports = { EventEmitterMicro: i(7) };
        },
        function (t, e, i) {
            "use strict";
            var r = i(8).SharedInstance,
                s = i(9).majorVersionNumber,
                n = i(34);
        ...
        function (t, e, i) {
            ...
            ((r = n.prototype).frameRequestedPhase = "requested"),
                ...
                (r.unsubscribe = function (t) {
                    return (
                        !!this._nextFrameSubscribers[t.id] && ((this._nextFrameSubscribers[t.id] = null), this._nextFrameSubscriberCount--, 0 === this._nextFrameSubscriberCount && this._cancel(), !0)
                    );
                }),
        ...
        function (t, e, i) {
            ...
            t.exports = function (t, e, i = "en") {
                ...
                return {
                    ...
                    name: "",
                    type: "WUIP",
                    price: { value: n, display: { actual: "$" + Number(n).toLocaleString(i, { minimumFractionDigits: 2 }), smart: "$" + a, from: "From $" + a, monthlyFrom: "From $" + a + "/mo." } },
                };
            };
        },
        function (t, e, i) {
        ...
        function (t, e, i) {
            ...
            t.exports = class extends Error {
                ...
                showHint() {
                    "endpoint" === this.type &&
                        (r.warn(this.message + " This may be expected if this page's locale doesn't have an Apple Online Store."),
                        r.info(
        ...
        function (t, e, i) {
            ...
            t.exports = class extends s {
                constructor(t, e) {
                    super(t, { ...e, method: "POST" }), (this.identifierParam = { ids: "ids", slugs: "slugs" });
                }
                createDummyItem(t) {
                    return r(t, "unauthorized");
                }
                formatResponseItem(t, e) {
                    let i = null;
                    return (
                        this.options.dummyPrices && "UNKNOWN" === e.productName && ((e = r(t, "unknown")), this.itemsWithDummyPrice.push(t)),
                        (i = new n(e)),
                        i.credit && 999999 === i.credit.value && this.itemsWithDummyPrice.push(t),
                        i
                    );
                }
                getItemsFromResponse(t) {
        ...
        function (t, e, i) {
            ...
            t.exports = function (t, e, i = "en") {
                ...
                return {
                    ...
                    credit: { value: n, display: { actual: "$" + Number(n).toLocaleString(i, { minimumFractionDigits: 2 }), smart: "$" + a, from: "From $" + a, upto: "Up to $" + a } },
                };
            };
        },
    ]);
